...
The data was cleaned and scaled as described in *bank_deposit-subscription-data-processing.ipynb*.   The exporatory data analysis was in notebook *bank_deposit-subscription-EDA.ipynb*.
...
The undersampling and specifying class_weight='balanced' yielded simailar results.    
...
#### One-hot-encoding:
    Most models were trained with One-hot-encoded categorical data except lightgbm which didn't allow One-hot-encoded categorical data. Random forest trained without One-hot-encoded catagorical data actually performed sightly better than with One-hot-encoded data. 
